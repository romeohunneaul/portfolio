...
export function ProjectsList({
  ...
  return (
    <div>
      <OpenOnHash />
      {list.map((p) => (
        <div key={p.slug} data-ask-kind="project" data-ask-id={p.slug}>
          <Disclosure
            id={p.slug}
            summary={
              <>
                ...
                <span className="col-span-2 max-w-[var(--measure)]">
                  {p.context}
                </span>
              </>
            }
          >
            <div className="flex max-w-[var(--measure)] flex-col gap-4">
              ...
              <AskButton context={{ kind: "project", id: p.slug }} className="self-start">
